 ...
 * Generated at: 2026-01-07 09:43:33 UTC
...
public final class v2a_005fmon_005fmaterialperkontrak_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /* 👉 indent tulisan TOTAL (± 5 spasi) */\r\n");
      out.write("    table.dataTable tbody tr.subtotal-row td:first-child {\r\n");
      out.write("        padding-left: 40px !important; /* ≈ 5 spasi */\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /* 🔵 garis penutup per NOMOR_KONTRAK_RINCI */\r\n");
      out.write("    /* 🔵 START KONTRAK RINCI */\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    /* 🔴 END KONTRAK RINCI (SATU GARIS PENUTUP SAJA) */\r\n");
      ...
      out.write("                                <th colspan=\"3\" class=\"hdr-wo\">FINAL BANGSANG</th>\r\n");
      ...
      out.write("            const vkdprov = document.getElementById('vc_kdprov').value; // ⬅️ INI\r\n");
      ...
      out.write("            console.log(\"🔄 Memuat daftar Provinsi...\");\r\n");
      out.write("\r\n");
      ...
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                    // ⬅️ INI KUNCI PERBAIKAN\r\n");
      out.write("                    kabSelect.disabled = true;\r\n");
      out.write("\r\n");
      out.write("                    console.log(\"✅ Provinsi berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("                } else {\r\n");
      out.write("                    const opt = document.createElement('option');\r\n");
      ...
      out.write("            console.log(\"🔄 Memuat daftar Kabupaten/Kota...\");\r\n");
      out.write("\r\n");
      out.write("            const params = new URLSearchParams();\r\n");
      ...
      out.write("                        select.appendChild(opt);\r\n");
      out.write("                    });\r\n");
      out.write("                    console.log(\"✅ Kabupaten/Kota berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("                } else {\r\n");
      out.write("                    const opt = document.createElement('option');\r\n");
      ...
      out.write("            console.log(\"🔄 Memuat daftar Kecamatan...\");\r\n");
      out.write("\r\n");
      out.write("            const params = new URLSearchParams();\r\n");
      ...
      out.write("                        select.appendChild(opt);\r\n");
      out.write("                    });\r\n");
      out.write("                    console.log(\"✅ Kecamatan berhasil dimuat:\", json.data.length, \"data\");\r\n");
      out.write("                } else {\r\n");
      out.write("                    const opt = document.createElement('option');\r\n");
      out.write("                    opt.textContent = \"Tidak ada data DISWIL\";\r\n");
      out.write("                    select.appendChild(opt);\r\n");
      ...
      out.write("                { data: 'JTR_FINAL', defaultContent: '', render: d => formatNumber(d, 0) },\r\n");
      out.write("                { data: 'JTM_FINAL', defaultContent: '', render: d => formatNumber(d, 0) },\r\n");
      out.write("                { data: 'GRD_FINAL', defaultContent: '', render: d => formatNumber(d, 0) },\r\n");
      ...
      out.write("                        }\r\n");
      out.write("                        // Versi 2: hanya angka → Tiang\r\n");
      ...
      out.write("\r\n");
      out.write("            // 🔥 Jika tabel sudah ada → reload saja\r\n");
      ...
      out.write("                    { data: 'JUMLAH_MDU', defaultContent: '', render: d => formatNumber(d, 0) },\r\n");
      ...
      out.write("                    { data: 'NAMA_UNITUPI' },\r\n");
      out.write("                    { data: 'UNITAP' },\r\n");
      out.write("                    { data: 'NAMA_UNITAP' },\r\n");
      out.write("                    { data: 'UNITUP' },\r\n");
      out.write("                    { data: 'NAMA_UNITUP' },\r\n");
      ...
      out.write("                },\r\n");
      out.write("\r\n");
      out.write("                // 🔥 Subtotal + garis akhir NOMOR_KONTRAK_RINCI\r\n");
      out.write("                drawCallback: function () {\r\n");
      out.write("\r\n");
      out.write("                    const api = this.api();\r\n");
      ...
      out.write("\r\n");
      out.write("                    // reset redraw\r\n");
      out.write("                    $tbody.find(\r\n");
      out.write("                        'tr.subtotal-row, tr.end-kontrak-row, tr.start-kontrak-row'\r\n");
      out.write("                    ).remove();\r\n");
      out.write("\r\n");
      out.write("                    const colQtyIndex = api.settings()[0].aoColumns.findIndex(\r\n");
      out.write("                        c => c.data === 'JUMLAH_MDU'\r\n");
      out.write("                    );\r\n");
      out.write("                    if (colQtyIndex === -1) return;\r\n");
      out.write("\r\n");
      out.write("                    let lastGroup   = null;\r\n");
      out.write("                    let lastKontrak = null;\r\n");
      out.write("                    let subtotal    = 0;\r\n");
      out.write("\r\n");
      out.write("                    const groupColors = {\r\n");
      out.write("                        'TIANG': '#e0f7fa',\r\n");
      out.write("                        'KABEL': '#fff3e0',\r\n");
      out.write("                        'AKSESORIS': '#e8f5e9'\r\n");
      out.write("                    };\r\n");
      out.write("\r\n");
      ...
      out.write("                        * START KONTRAK RINCI\r\n");
      out.write("                        * ========================== */\r\n");
      out.write("                        if (i === 0 || kontrak !== lastKontrak) {\r\n");
      out.write("                            insertStartOfKontrak(rowsNodes[i], kontrak);\r\n");
      out.write("                        }\r\n");
      out.write("\r\n");
      out.write("                        /* ==========================\r\n");
      out.write("                        * GANTI KONTRAK RINCI\r\n");
      out.write("                        * ========================== */\r\n");
      out.write("                        if (lastKontrak !== null && kontrak !== lastKontrak) {\r\n");
      out.write("\r\n");
      out.write("                            // tutup subtotal group terakhir kontrak lama\r\n");
      out.write("                            insertSubtotal(\r\n");
      out.write("                                rowsNodes[i],\r\n");
      out.write("                                lastGroup,\r\n");
      out.write("                                subtotal,\r\n");
      out.write("                                colQtyIndex,\r\n");
      out.write("                                groupColors[lastGroup] || '#f5f5f5'\r\n");
      out.write("                            );\r\n");
      out.write("\r\n");
      out.write("                            // END OF KONTRAK RINCI\r\n");
      out.write("                            insertEndOfKontrak(rowsNodes[i], lastKontrak);\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("                        /* ==========================\r\n");
      out.write("                        * GANTI MATERIAL GROUP\r\n");
      out.write("                        * ========================== */\r\n");
      out.write("                        if (lastGroup !== null && group !== lastGroup) {\r\n");
      out.write("                            insertSubtotal(\r\n");
      out.write("                                rowsNodes[i],\r\n");
      out.write("                                lastGroup,\r\n");
      out.write("                                subtotal,\r\n");
      ...
      out.write("\r\n");
      out.write("                    /* ==========================\r\n");
      out.write("                    * TUTUP KONTRAK TERAKHIR\r\n");
      out.write("                    * ========================== */\r\n");
      out.write("                    insertSubtotal(\r\n");
      out.write("                        null,\r\n");
      out.write("                        lastGroup,\r\n");
      ...
      out.write("                    );\r\n");
      out.write("\r\n");
      out.write("                    insertEndOfKontrak(null, lastKontrak);\r\n");
      out.write("\r\n");
      out.write("                    /* =================================================\r\n");
      out.write("                    * FUNGSI START OF KONTRAK\r\n");
      out.write("                    * ================================================= */\r\n");
      out.write("                    function insertStartOfKontrak(refNode, nomorKontrak) {\r\n");
      out.write("\r\n");
      out.write("                        if (!nomorKontrak) return;\r\n");
      out.write("\r\n");
      out.write("                        const totalCols = api.columns().count();\r\n");
      out.write("\r\n");
      out.write("                        let html =\r\n");
      out.write("                            '<tr class=\"start-kontrak-row\">' +\r\n");
      out.write("                                '<td colspan=\"' + totalCols + '\" class=\"start-kontrak-text\">' +\r\n");
      out.write("                                    'START OF KONTRAK RINCI : ' + nomorKontrak +\r\n");
      out.write("                                '</td>' +\r\n");
      out.write("                            '</tr>';\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("                    /* =================================================\r\n");
      out.write("                    * FUNGSI SUBTOTAL\r\n");
      out.write("                    * ================================================= */\r\n");
      out.write("                    function insertSubtotal(refNode, group, value, colIndex, bgColor) {\r\n");
      out.write("\r\n");
      out.write("                        if (!group) return;\r\n");
      out.write("\r\n");
      out.write("                        const totalCols = api.columns().count();\r\n");
      out.write("                        let html =\r\n");
      out.write("                            '<tr class=\"subtotal-row fw-bold\" style=\"background-color:' + bgColor + '\">';\r\n");
      out.write("\r\n");
      out.write("                        for (let i = 0; i < totalCols; i++) {\r\n");
      out.write("                            if (i === 0) {\r\n");
      out.write("                                html += '<td>TOTAL ' + group + '</td>';\r\n");
      out.write("                            } else if (i === colIndex) {\r\n");
      out.write("                                // Jika angka, rata kanan\r\n");
      out.write("                                 html += '<td class=\"textnumeric\">' + formatNumber(value, 0) + '</td>';\r\n");
      out.write("                            } else {\r\n");
      ...
      out.write("\r\n");
      out.write("                    /* =================================================\r\n");
      out.write("                    * FUNGSI END OF KONTRAK\r\n");
      out.write("                    * ================================================= */\r\n");
      out.write("                    function insertEndOfKontrak(refNode, nomorKontrak) {\r\n");
      out.write("\r\n");
      out.write("                        if (!nomorKontrak) return;\r\n");
      out.write("\r\n");
      out.write("                        const totalCols = api.columns().count();\r\n");
      ...
      out.write("                                '<td colspan=\"' + totalCols + '\" class=\"end-kontrak-text\">' +\r\n");
      out.write("                                    'END OF KONTRAK RINCI : ' + nomorKontrak +\r\n");
      out.write("                                '</td>' +\r\n");
      out.write("                            '</tr>';\r\n");
      out.write("\r\n");
      out.write("                        if (refNode) {\r\n");
      ...
      out.write("                } = detailFilterParams;\r\n");
      out.write("\r\n");
      out.write("                if (!vtahun_laporan || !vinfolabel) {\r\n");
      ...
      out.write("                    'DETAIL_' + vtahun_laporan + '_' + vinfolabel + '.xlsx'\r\n");
      out.write("                );\r\n");
      out.write("\r\n");
      out.write("            } catch (e) {\r\n");
      out.write("                console.error(e);\r\n");
